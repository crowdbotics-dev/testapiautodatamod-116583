...
## Project Structure
    ...
    ├── testapiautodatamod_116583  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_116583`
...
2. Clone this repo and `cd testapiautodatamod_116583`
